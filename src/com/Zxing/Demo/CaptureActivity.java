...
public class CaptureActivity extends Activity implements Callback,RequestFilter
{
...
//				+ obj.getText());
		Intent intent = new Intent(CaptureActivity.this,ESClientService.class);
		intent.setAction(ACTION_CHECK_QRCODE);
		intent.putExtra(KEY_QRCODE,obj.getText());
		intent.putExtra(KEY_DID, getIntent().getStringExtra(KEY_DID));
		intent.putExtra(KEY_TID, getIntent().getStringExtra(KEY_TID));
		startService(intent);
		finish();
	}
